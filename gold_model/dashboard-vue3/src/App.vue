...
const tabs = [
  ...
  { key: 'backtest', tkey: 'nav.backtest', gold: false },
  { key: 'compare', tkey: 'nav.compare', gold: false },
  { key: 'versions', tkey: 'nav.versions', gold: false },
  { key: 'walkforward', tkey: 'nav.walkforward', gold: false },
  { key: 'validation', tkey: 'nav.validation', gold: false },
